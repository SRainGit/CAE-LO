...
%             end
            plot3([xyz1_aligned(1,1), xyz2_aligned(1,1)], ...
                [xyz1_aligned(1,2), xyz2_aligned(1,2)], ...
                [xyz1_aligned(1,3), xyz2_aligned(1,3)], 'r-');
            for i = 2 : size(xyz1_aligned, 1)
                plot3([xyz1_aligned(i,1), xyz2_aligned(i,1)], ...
                     [xyz1_aligned(i,2), xyz2_aligned(i,2)], ...
                     [xyz1_aligned(i,3), xyz2_aligned(i,3)], 'k-');
            end
